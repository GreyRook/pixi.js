 ...
 * @memberof PIXI
 */
PIXI.LinearGradientBrush = function (colors, alphas, ratios, x0, y0, x1, y1)
{
...
PIXI.LinearGradientBrush.prototype = Object.create(PIXI.Brush.prototype);
PIXI.LinearGradientBrush.prototype.constructor = PIXI.LinearGradientBrush;
 ...
 */
PIXI.LinearGradientBrush.prototype.getCanvasBrush = function (context)
{
 ...
 */
PIXI.LinearGradientBrush.prototype.fillCanvas = function (context, worldAlpha) {
 ...
 * @param worldAlpha {number}
 */
PIXI.LinearGradientBrush.prototype.strokeCanvas = function (context, worldAlpha) {
    context.globalAlpha = this.alpha * worldAlpha;
